...
import static hello.rent.domain.model.vo.RentStatus.RENT_AVAILABLE;
...
import hello.rent.domain.model.vo.LateFee;
import hello.rent.domain.model.vo.RentStatus;
import hello.rent.domain.model.vo.RentalCardNo;
...
public class RentalCard {
    ...
    public static RentalCard sample(){
        ...
        rentalCard.setRentStatus(RENT_AVAILABLE);
    ...
    public long makeAvailableRental(long point) throws Exception {
        ...
        {
            this.rentStatus = RENT_AVAILABLE;
        }
